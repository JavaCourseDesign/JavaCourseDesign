...
import com.management.server.models.DictionaryInfo;
import com.management.server.models.MenuInfo;
import com.management.server.models.UserType;
import com.management.server.payload.request.DataRequest;
import com.management.server.payload.response.DataResponse;
import com.management.server.payload.response.MyTreeNode;
import com.management.server.payload.response.OptionItem;
import com.management.server.payload.response.OptionItemList;
import com.management.server.repositories.DictionaryInfoRepository;
import com.management.server.repositories.MenuInfoRepository;
import com.management.server.repositories.UserRepository;
import com.management.server.repositories.UserTypeRepository;
import com.management.server.service.BaseService;
...
public class BaseController {
    ...
    public DataResponse getMenuList(@Valid @RequestBody DataRequest dataRequest) {
        ...
        if (userTypeId == null) {
            ...
            userTypeId = Integer.valueOf(userRepository.findByUserId(userId).getUserType().getId());
        }
    ...
    public OptionItemList getRoleOptionItemList(@Valid @RequestBody DataRequest dataRequest) {
        ...
        for (UserType ut : uList) {
            itemList.add(new OptionItem(Integer.valueOf(ut.getId()), null, ut.getName().name()));
        }

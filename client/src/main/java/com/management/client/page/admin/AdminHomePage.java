...
public class AdminHomePage extends SplitPane {
    @FXML
    ...
    public AdminHomePage() {
        FXMLLoader fxmlLoader = new FXMLLoader(ClientApplication.class.getResource("/adminFxml/AdminHomePage.fxml")); // 确保路径正确
    ...
    {
        ArrayList<Map> list=(ArrayList<Map>) request("/getAdminHomework", null).getData();
        for(Map m:list)
        {
    ...
    {
        List<Map> events = (List<Map>) request("/getAllEventsExceptLessons",null).getData();

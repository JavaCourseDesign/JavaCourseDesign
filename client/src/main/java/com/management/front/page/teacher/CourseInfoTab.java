...
public class CourseInfoTab extends Tab {
    ...
    private void displayCourseInfo() {
        ...
        ImageView ppt=new ImageView(new Image(HelloApplication.class.getResourceAsStream("images/ppt.png")));
        ImageView pdf=new ImageView(new Image(HelloApplication.class.getResourceAsStream("images/pdf.png")));
